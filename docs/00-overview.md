...
- **Calm and minimal.** Few taps or clicks, little typing, no clutter. It should feel like a well-kept paper planner.
...
## Design principles
1. **Today is the heart.** Everything frequent is at most two clicks or taps from Today.
