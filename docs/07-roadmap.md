...
**Definition of done:** a teacher can prepare a Plan for tomorrow's Session from Today in two taps/clicks, reuse a previous Plan, and add a learner Note in under 10 seconds; SET-005 toggles hide/show both modules.
